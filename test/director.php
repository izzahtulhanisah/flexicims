...
<body>
	...
	?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><center>USER : <b>DIRECTOR</b></center></h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
        ...
        <div class="col-lg-12">
					<div class="panel panel-primary">
							<div class="panel-heading">
									<p>LIST OF DIRECTORS
									<button class="btn btn-success btn-sm pull-right" onclick="window.location.href='directoradd.php'"><i class="fa fa-plus" style="font-size:12px"></i> New User</button></p>
							</div>
							...
							<tbody>
								<tr>
									<td><?php echo $username; ?><span class="pull-right">
										...
										<button type="button" onclick="window.location.href='directoredit.php?loginid=<?php echo $id; ?>'" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-edit"></i> Edit</button>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="background-color: lightgrey">
				...
				<h4 class="modal-title" id="myModalLabel"><center>VIEW DIRECTOR DETAILS</center></h4>
			</div>
			<?php

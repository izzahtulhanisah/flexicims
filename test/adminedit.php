...
<body>
	...
	?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Edit Admin Details</h3>
                </div>
                <!-- /.col-lg-12 -->
...
if($res === TRUE){
	echo "<script type = \"text/javascript\">
		...
		window.location = (\"adminedit.php?loginid=".$loginid."\")
		</script>";
	}
...
<button class="btn btn-bg-grey" type="button" onclick="window.location.href='admin.php'">Back</button>
<br><br>
</form>

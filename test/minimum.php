                            ...
                            <div class="dataTable_wrapper">
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover table-sm" id="dataTables-example">
										...
										if($secpass == 2){
											$select = "SELECT i.*,l.location FROM inventory as i INNER JOIN location as l ON l.location = i.location WHERE l.manager_id = '$logid' AND i.status = 'Minimum' ORDER BY id DESC ";
										}
										elseif($secpass == 3){
											$select = "SELECT i.*,l.location FROM inventory as i INNER JOIN location as l ON l.location = i.location WHERE l.manager_id = '$leadid' AND i.status = 'Minimum' ORDER BY id DESC ";
										}
										else{
											$select = "SELECT * FROM inventory WHERE status = 'Minimum' ORDER BY id DESC ";
										}
